...
class DocumentManager {
    constructor() {
         ...
         */
        this.onDocumentOpened = new EventHandler.EventHandler();
        /**
         * Event fired when a document is closed
         */
        this.onDocumentClosed = new EventHandler.EventHandler();
        /**
         * Event fired when a document is saved
         */
        this.onDocumentSaved = new EventHandler.EventHandler();
        /**
         * Event fired when the active document changes
         */
        this.onActiveDocumentChanged = new EventHandler.EventHandler();
    }
    /**
    ...
    createDocument(resource, editor) {
        return tslib_es6.__awaiter(this, void 0, void 0, function* () {
            ...
            const document = {
                ...
                resource,
                editor,
                open: () => tslib_es6.__awaiter(this, void 0, void 0, function* () {
                    yield resource.load();
                ...
                save: () => tslib_es6.__awaiter(this, void 0, void 0, function* () {
